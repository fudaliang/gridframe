...
import com.softcloud.grid.privadmin.dao.MenuDao;
import com.softcloud.grid.privadmin.dao.RoleMenuDao;
...
public class MenuServiceImpl implements MenuService {
    ...
    @Cacheable(value = "permission", key = "0000L")
    @Override
    public List<MenuDO> publicMenus() {
        return menuMapper.listPublicMenu();
    }
...
//			tree.setAttributes(map);
    ...
    @Override
    public List<UserMenuPermissionDTO> PermsByUserId(Long userId) {

        List<UserMenuPermissionDTO> perms = menuMapper.listUserPerms(userId);
  
        //TODO 检查查询出来的模块操作权限和是否合法
        return perms;
    }
