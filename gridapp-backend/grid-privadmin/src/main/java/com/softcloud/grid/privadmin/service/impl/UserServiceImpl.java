...
import com.softcloud.grid.privadmin.dao.UserRoleDao;
import com.softcloud.grid.privadmin.domain.DeptDO;
import com.softcloud.grid.privadmin.domain.UserDO;
import com.softcloud.grid.privadmin.domain.UserRoleDO;
...
public class UserServiceImpl implements UserService {
	...
	@Override
	public List<UserDO>  batchList(Long[] userIds) {
		return userMapper.batchList(userIds);
	...
	public int remove(Long userId) {
		int count =userMapper.remove(userId);
		userRoleMapper.removeByUserId(userId);
		sysUserDeptMapper.removeByUserId(userId);
		return count;
	}
	...
	public int batchremove(Long[] userIds) {
		...
		sysUserDeptMapper.batchRemoveByUserId(userIds);
		return count;
	}
	...
	public Tree<DeptDO> getTree() {
		...
		Long[] pDepts = deptMapper.listParentDeptID();
