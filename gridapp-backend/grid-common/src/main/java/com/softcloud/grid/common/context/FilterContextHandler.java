package com.softcloud.grid.common.context;
...
public class FilterContextHandler {
    ...
    public static String getDeptId() {
        Object value = get(CommonConstants.CONTEXT_DEPTID);
        return returnObjectValue(value);
    }
    ...
    public static void setDeptId(String name) {
        set(CommonConstants.CONTEXT_DEPTID, name);
    }
